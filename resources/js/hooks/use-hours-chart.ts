...
import { clearHoursChartCache, fetchHoursChartData, fetchWithRetry, formatDateForApi, isValidDateFormat } from '@/lib/services/hours-chart.service';
 ...
 */
export const useMinimumLoadingDuration = (isLoading: boolean, minimumMs: number = 500): boolean => {
