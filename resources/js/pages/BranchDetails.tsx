...
import { BranchTopProducts } from '@/components/branch-top-products';
...
export default function BranchDetails({ id, name, region, dateRange }: BranchDetailsProps) {
    ...
    return (
        <>
            ...
            <div className={`ios-page-container min-h-screen bg-background ${isExiting ? 'ios-page-exit' : ''}`}>
                <div className="mx-auto w-full max-w-md">
                    ...
                    <div className="flex items-center gap-3 border-b border-border p-4">
                        <Button
                            ...
                            className="flex items-center gap-2 p-2 text-foreground hover:bg-accent"
                        >
                        ...
                        <div className="flex flex-1 items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <h1 className="text-lg leading-tight font-semibold text-foreground">{name}</h1>
                    ...
                    <div className="space-y-4 p-4">
                        ...
                        {storeId === null && (
                            <div className="rounded-lg border border-destructive/20 bg-destructive/5 p-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-sm font-medium text-destructive">ID de sucursal inválido</p>
                                </div>
                                <p className="mt-1 text-sm text-destructive/80">El ID de la sucursal "{id}" no es válido. Debe ser un número.</p>
                            </div>
                        )}
                        ...
                        {/* Branch Top Products - Only show when valid storeId and date range */}
                        {storeId !== null && isValidDateRange && (
                            <BranchTopProducts data={branchData?.top_products || null} isLoading={isBranchLoading} error={branchError} />
                        )}
                    </div>
                </div>
            </div>
