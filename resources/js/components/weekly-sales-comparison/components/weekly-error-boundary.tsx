 ...
 * ```
 */
export class WeeklyErrorBoundary extends React.Component<WeeklyErrorBoundaryProps, ErrorBoundaryState> {
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 space-y-3">
                                <div>
                                    <h3 className="font-semibold text-destructive">Error en Ventas Semanales</h3>
                                    <p className="mt-1 text-sm text-muted-foreground">
                                        No se pudieron cargar los datos de ventas semanales. Esto puede ser temporal.
                                    </p>
                                </div>
