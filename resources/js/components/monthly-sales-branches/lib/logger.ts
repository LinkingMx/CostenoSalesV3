/**
 * Conditional logging utility for monthly-sales-branches component
 *
 * Features:
 ...
 */
const DEBUG_MONTHLY_BRANCHES = (() => {
    if (typeof window === 'undefined' || process.env.NODE_ENV !== 'development') {
        return false;
    }
    return window.localStorage.getItem('debug:monthly-branches') === 'true';
})();
...
export const logger = {
    ...
    debug: (message: string, data?: unknown): void => {
        if (!DEBUG_MONTHLY_BRANCHES) return;
        ...
        console.debug(`[MonthlyBranches] ${message}`, logData);
    },
    ...
    warn: (message: string, data?: unknown): void => {
        ...
        console.warn(`[MonthlyBranches] ${message}`, data);
    },
    ...
    error: (message: string, data?: unknown): void => {
        console.error(`[MonthlyBranches] ${message}`, data);
    },
    ...
    info: (message: string, data?: unknown): void => {
        if (!DEBUG_MONTHLY_BRANCHES) return;
        console.info(`[MonthlyBranches] ${message}`, data);
    },
};

/**
 * Enable debug logging in browser console:
 * localStorage.setItem('debug:monthly-branches', 'true')
 *
 * Disable debug logging:
 * localStorage.removeItem('debug:monthly-branches')
 */