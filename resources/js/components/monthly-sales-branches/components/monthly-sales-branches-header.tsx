    ...
    return (
        <div className="mb-3 flex items-center gap-3">
            ...
            <div className="flex flex-col">
                <h2 className="text-base leading-none font-semibold tracking-tight text-foreground">Ventas por sucursal (Mensual)</h2>
                <p className="mt-0.5 text-sm text-muted-foreground">Ventas mensuales por sucursal detalladas</p>
            </div>
        </div>
    );
}
