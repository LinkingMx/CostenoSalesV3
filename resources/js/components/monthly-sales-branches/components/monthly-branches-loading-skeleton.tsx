...
/**
 * Loading skeleton component for monthly branches data.
 * Displays placeholder content while API data is being fetched.
 *
 * @component
 * @returns {JSX.Element} Loading skeleton matching the structure of MonthlySalesBranches
 *
    ...
    <Card className="w-full">
      <CardContent className="px-4 py-3">
        ...
        <div
          className="space-y-2"
          role="region"
          aria-label="Cargando datos de sucursales mensuales"
        >
...
function BranchSkeletonItem() {
  return (
    <div className="rounded-lg bg-muted border border-border animate-pulse">
