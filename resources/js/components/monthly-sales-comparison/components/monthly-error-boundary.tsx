 ...
 * ```
 */
export class MonthlyErrorBoundary extends React.Component<
  MonthlyErrorBoundaryProps,
  ErrorBoundaryState
> {
              ...
              <div className="flex-1 space-y-3">
                <div>
                  <h3 className="font-semibold text-destructive">
                    Error en Ventas Mensuales
                  </h3>
                  <p className="mt-1 text-sm text-muted-foreground">
                    No se pudieron cargar los datos de ventas mensuales. 
