    ...
    return (
        <div className="space-y-4">
            ...
            <div className="rounded-lg border bg-card p-4">
                <h3 className="mb-3 text-lg font-semibold">Seleccionar Fecha</h3>
                {/* MainFilterCalendar would go here */}
                <p className="text-sm text-muted-foreground">Integrar con MainFilterCalendar para selección de fecha</p>
            </div>
