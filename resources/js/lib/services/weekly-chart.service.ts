...
import type { ChartDayData, WeeklyChartData } from '@/components/weekly-chart-comparison/types';
 ...
 */
export const fetchWeeklyChartData = async (startDate: string, endDate: string): Promise<{ data: WeeklyChartData | null; error?: string }> => {
    // Generate cache key
    ...
    const requestPromise = (async () => {
        try {
            ...
            const response = await apiPost<WeeklyChartApiResponse>(API_ENDPOINTS.MAIN_DASHBOARD, request);
