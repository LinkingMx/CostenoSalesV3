 ...
 */
export const fetchMonthlyChartData = async (startDate: string, endDate: string): Promise<{ data: MonthlyChartData | null; error?: string }> => {
    // Generate cache key
    ...
    const requestPromise = (async () => {
        try {
            ...
            const response = await apiPost<MonthlyChartApiResponse>(API_ENDPOINTS.MAIN_DASHBOARD, request);
